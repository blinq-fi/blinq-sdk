...
export var protobufPackage = "xplore";
...
export function transactionStatusFromJSON(object) {
    switch (object) {
        case 0:
        case "UNKNOWN":
...
export function transactionStatusToJSON(object) {
    switch (object) {
...
export var ChainToken = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = new BinaryWriter(); }
        if (message.chainId !== "") {
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseChainToken();
    ...
    create: function (base) {
        return ChainToken.fromPartial(base !== null && base !== void 0 ? base : {});
    },
...
export var TransactionRecordRequest = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = new BinaryWriter(); }
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseTransactionRecordRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create: function (base) {
        return TransactionRecordRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseTransactionRecordRequest();
...
export var TransactionRecord = {
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseTransactionRecord();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create: function (base) {
        return TransactionRecord.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
...
export var SwapRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseSwapRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create: function (base) {
        return SwapRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
...
export var TransactionData = {
    ...
    create: function (base) {
        return TransactionData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var message = createBaseTransactionData();
...
export var SwapResponse = {
    encode: function (message, writer) {
        ...
        for (var _i = 0, _a = message.pathSteps; _i < _a.length; _i++) {
            var v = _a[_i];
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseSwapResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    fromJSON: function (object) {
        return {
            ...
            amountOut: isSet(object.amountOut) ? globalThis.String(object.amountOut) : "",
            outputToken: isSet(object.outputToken) ? ChainToken.fromJSON(object.outputToken) : undefined,
            pathSteps: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.pathSteps) ? object.pathSteps.map(function (e) { return Step.fromJSON(e); }) : [],
            amountIn: isSet(object.amountIn) ? globalThis.String(object.amountIn) : "",
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.pathSteps) === null || _a === void 0 ? void 0 : _a.length) {
            obj.pathSteps = message.pathSteps.map(function (e) { return Step.toJSON(e); });
        }
        if (message.amountIn !== "") {
            obj.amountIn = message.amountIn;
        }
    ...
    create: function (base) {
        return SwapResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        var message = createBaseSwapResponse();
        ...
        message.outputToken = (object.outputToken !== undefined && object.outputToken !== null)
            ? ChainToken.fromPartial(object.outputToken)
            : undefined;
        message.pathSteps = ((_c = object.pathSteps) === null || _c === void 0 ? void 0 : _c.map(function (e) { return Step.fromPartial(e); })) || [];
...
export var EvmTransactionData = {
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseEvmTransactionData();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create: function (base) {
        return EvmTransactionData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseEvmTransactionData();
...
export var SolanaTransactionData = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = new BinaryWriter(); }
        for (var _i = 0, _a = message.txMessages; _i < _a.length; _i++) {
            var v = _a[_i];
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseSolanaTransactionData();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    fromJSON: function (object) {
        return {
            txMessages: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.txMessages)
                ? object.txMessages.map(function (e) { return globalThis.String(e); })
                : [],
    ...
    create: function (base) {
        return SolanaTransactionData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseSolanaTransactionData();
        message.txMessages = ((_a = object.txMessages) === null || _a === void 0 ? void 0 : _a.map(function (e) { return e; })) || [];
...
export var SuiTransactionData = {
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseSuiTransactionData();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create: function (base) {
        return SuiTransactionData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d;
        var message = createBaseSuiTransactionData();
...
export var XploreRequest = {
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseXploreRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create: function (base) {
        return XploreRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        var message = createBaseXploreRequest();
...
export var APISwapResponse = {
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseAPISwapResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create: function (base) {
        return APISwapResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e;
        var message = createBaseAPISwapResponse();
        ...
        message.outputToken = (object.outputToken !== undefined && object.outputToken !== null)
            ? ChainToken.fromPartial(object.outputToken)
            : undefined;
        message.pathSteps = ((_d = object.pathSteps) === null || _d === void 0 ? void 0 : _d.map(function (e) { return Step.fromPartial(e); })) || [];
...
export var RouteStep = {
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseRouteStep();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    create: function (base) {
        return RouteStep.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseRouteStep();
...
export var XploreResponse = {
    encode: function (message, writer) {
        ...
        for (var _i = 0, _a = message.route; _i < _a.length; _i++) {
            var v = _a[_i];
    ...
    decode: function (input, length) {
        var reader = input instanceof BinaryReader ? input : new BinaryReader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseXploreResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1: {
    ...
    fromJSON: function (object) {
        return {
            ...
            route: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.route) ? object.route.map(function (e) { return RouteStep.fromJSON(e); }) : [],
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.route) === null || _a === void 0 ? void 0 : _a.length) {
            obj.route = message.route.map(function (e) { return RouteStep.toJSON(e); });
        }
        if (message.executionTime !== 0) {
    ...
    create: function (base) {
        return XploreResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        var message = createBaseXploreResponse();
        ...
        message.route = ((_d = object.route) === null || _d === void 0 ? void 0 : _d.map(function (e) { return RouteStep.fromPartial(e); })) || [];
...
export var AggregatorService = {
    aggregateCall: {
        path: "/xplore.Aggregator/AggregateCall",
        requestStream: false,
        responseStream: false,
        requestSerialize: function (value) { return Buffer.from(XploreRequest.encode(value).finish()); },
        requestDeserialize: function (value) { return XploreRequest.decode(value); },
        responseSerialize: function (value) { return Buffer.from(XploreResponse.encode(value).finish()); },
        responseDeserialize: function (value) { return XploreResponse.decode(value); },
    },
    getTransactionRecord: {
        path: "/xplore.Aggregator/GetTransactionRecord",
        requestStream: false,
        responseStream: false,
        requestSerialize: function (value) { return Buffer.from(TransactionRecordRequest.encode(value).finish()); },
        requestDeserialize: function (value) { return TransactionRecordRequest.decode(value); },
        responseSerialize: function (value) { return Buffer.from(TransactionRecord.encode(value).finish()); },
        responseDeserialize: function (value) { return TransactionRecord.decode(value); },
    },
};
export var AggregatorClient = makeGenericClientConstructor(AggregatorService, "xplore.Aggregator");
